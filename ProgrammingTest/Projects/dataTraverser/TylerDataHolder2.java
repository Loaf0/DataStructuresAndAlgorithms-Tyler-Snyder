...
public class TylerDataHolder2
{
	...
	public TylerDataHolder2(int arrayLength)
	{
	...
	{
		interator++;
		return friends[interator-1];
	}
	
	public boolean hasNext() 
	{
		if(friends[interator+1] != null) 
		{
			return true;
		}
		else
	...
	public TylerDataHolder2 deepClone() 
	{
		TylerDataHolder2 cloneArray = new TylerDataHolder2(friends.length);
		for(int i = 0; i < friends.length; i++) 
		{
